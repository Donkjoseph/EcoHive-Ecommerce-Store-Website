...
class OrderItem(models.Model):
    ...
    scanned_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name='scanned_orders')
    ...
    def confirm_order(self, delivery_agent):
        if self.qr_scanned and self.scanned_by == delivery_agent.user:
            self.status = OrderItem.OrderItemStatus.CONFIRMED
            self.save()
