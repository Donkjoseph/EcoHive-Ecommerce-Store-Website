...
class CertificationAdmin(admin.ModelAdmin):
    list_display = ('first_name', 'last_name', 'certification_authority', 'certification_number','address', 'certification_image', 'timestamp','is_approved','latitude','longitude')  # Add 'certification_number' to list_display
...
class OrderItemAdmin(admin.ModelAdmin):
    list_display = ('id', 'order', 'product', 'seller', 'quantity', 'price', 'total_price', 'status')
    list_filter = ('status', 'seller')
    search_fields = ('id', 'order__id', 'product__product_name', 'seller__name')
    readonly_fields = ('total_price', 'qr_code')
